...
// --- EXPORTAMOS LAS INSTANCIAS DE LOS SERVICIOS DEL SERVIDOR ---

export function getDb() {
  return initializeAdmin().firestore();
}

// ✅ NUEVA FUNCIÓN PARA OBTENER LA REALTIME DATABASE DEL SERVIDOR
export function getRtdb() {
  return initializeAdmin().database();
}

// --- EL RESTO DEL ARCHIVO (getStudentById, createOrUpdateStudentServer, etc.) NO CAMBIA ---
